...
{: .box-note}
I published the docker image of `snifipv6` on Docker so you can jump to the docker-compose.yml section if you just want to setup the container and use `gpailler/snifipv6:latest` container name.
